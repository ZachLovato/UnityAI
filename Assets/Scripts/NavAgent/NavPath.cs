...
public class NavPath : MonoBehaviour
{
	...
	public NavNode GetNextNode(NavNode navNode)
	{
		...
		if (index == path.Count - 1)
		{
			switch (endAction)
			{
				case EndAction.STOP: return null;
				case EndAction.RANDOM: SetRandomEndNode(); break;
				case EndAction.PINGPONG: SwapStartAndEndNode(); break;
			}
	...
	public void SwapStartAndEndNode()
	{
		NavNode loopNode = startNode;
		startNode = endNode;
		endNode = loopNode;
	}
