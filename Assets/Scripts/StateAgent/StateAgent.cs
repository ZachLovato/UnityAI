...
public class StateAgent : Agent
{
    ...
    void Start()
    {
        ...
        stateMachine.AddState(new DodgeState(this));
		...
		stateMachine.AddTransition(nameof(IdleState), new Transition(new Condition[] { enemySeenCondition, healthLowCondition }), nameof(DodgeState));
